...
function Profile() {
  ...
  return (
    <div className="m-6">
      <div
        className="px-2 py-4 flex items-center gap-3 bg-[#fff]/70 rounded-[0.8rem]
        hover:bg-[#fff]/50 transition duration-300 ease-in-out cursor-pointer border-2 border-transparent hover:border-2 hover:border-white"
        ...
        <div className="grid grid-cols-2 gap-4">
          <div className="text-gray-400">
            ...
            <p className="pl-4 relative flex gap-2">
              ...
              <span className="font-medium text-4xl text-[#fff]">
                {tasks.length}
              </span>
            </p>
          </div>
      ...
      <h3 className="mt-8 font-medium text-zinc-400" ></h3>
    </div>
  );
}
